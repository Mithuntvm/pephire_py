...
SkillWords$value = tolower(SkillWords$value)
SkillWords = anti_join(SkillWords,CommonWords,by = "value")
print(paste0('skill mapping started on ', Sys.time()))

#Data clean up
colnames(IgnoreListMainCluster) = c('value')
SkillWords = anti_join(SkillWords, IgnoreListMainCluster,by ="value")
...
SkillWords = anti_join(SkillWords, IgnoreListMainCluster,by = 'MappedTo')
