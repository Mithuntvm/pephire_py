...
Route::group(['middleware' => 'App\Http\Middleware\UserMiddleware'], function () {
    ...
    Route::get('/app/jobs', 'JobController@app_jobs');
    Route::post('/app/jobs', 'JobController@app_store');
    ...
    Route::get('/download/{filename}', 'JobController@downloadResume');
    Route::post('/candidate/updatestatus', 'JobController@updatecandidatestatus');
    Route::post('/interview/delete/', 'JobController@interviewDelete');
...
Route::get('/downloadResume/{ruid}', 'ResumeController@download_resume');
Route::post('/download/candidateResumes', 'JobController@candidateResumes');
Route::post('/whatsappChat', 'JobController@whatsappChat');
...
Route::get('/upload-file', 'FileUploadController@gdrive');
Route::post('/upload-file', 'FileUploadController@uploadFile')->name('upload-file');
Route::get('/auth/google/callback', 'FileUploadController@handleCallback');
Route::post('/proxy/upload-file', 'FileUploadController@proxyUploadFile');
Route::get('/start-job', 'FileUploadController@startJob');
...
Route::get('/delete_candidate/{uid}', 'InterviewConfirmationController@delete_candidate');
Route::post('/select_slot/{uid}', 'InterviewConfirmationController@confirm_slot')->name('confirm_slots');
Route::post('/rechedule_slot/{uid}', 'InterviewConfirmationController@rechedule_slot')->name('rechedule_slot');
Route::post('/accept_candidate/{uid}', 'InterviewConfirmationController@accept_candidate');
Route::post('/reject_candidate/{uid}', 'InterviewConfirmationController@reject_candidate');
Route::post('/meeting_link/{uid}', 'InterviewConfirmationController@meeting_link');
Route::post('/update/candidateStatus', 'JobController@update_candidateStatus');
Route::get('/interviewer/Confirmation', 'InterviewConfirmationController@interviewer_confirmation')->name('interview_confirmation');
Route::get('/interview/candidateTimeslot/{sluid}', 'InterviewConfirmationController@viewCandidateTimeslot')->name('interviewer_confirmation.view');
