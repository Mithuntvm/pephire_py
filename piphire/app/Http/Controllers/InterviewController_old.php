...
class InterviewController extends Controller
{
    ...
    public function storeShortlistedCandidates(Request $request, $juid)
    {
        ...
        foreach ($request->candidatesArr as $candidate_id) {
            ...
            if ($cand == 0) {
                ...
                //         'usertype' => "candidate",
                //         'Parameters' => 'DataLink',
                //         'ParameterValue' => route('candidateProfile.edit', $candidate->cuid),
                //         'oid' => $candidate->organization_id,
                ...
                //         ->update(['parameterValue' => route('candidateProfile.edit', $candidate->cuid)]);
    ...
    public function storeInterviewTimeSlot(Request $request, $juid)
    {
        ...
        Log::error($request->duration.'mmmmmmmmmmmmmmmm');
