...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#jobs').DataTable({
                ajax: {
                    url: "{{ action('JobController@ResumedataTable',['juid'=>$job->juid]) }}",
                    type: "POST",
                    data: {
                ...
                columns: [
                    { data: "name", width: '30%' },
                    { data: "filesize", width: '40%' },
                    {
                        data: "actions",
                        orderable: false,
                        width: '30%',
                        render: function (data, type, row ) {
                          return '<a href="javascript:void(0);" class="btn btn-flat btn-warning">' +
    ...
    @endif
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">{{$job->name}}</h3>
