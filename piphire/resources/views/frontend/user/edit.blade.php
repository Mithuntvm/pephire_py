        ...
        <div class="row">
          <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="common-section">
              <h4 class="titlehead"><span>Edit User</span></h4>
              <form name="editprofile" id="useredit" enctype="multipart/form-data" method="post" class="common-form edit-profile">
                @csrf
                ...
                <div class="form-section">
                  ...
                  <input class="form-control" id="projectinput3" type="email" name="email" placeholder="Email" value="{{$user->email}}">
                </div>
                <div class="form-section">
