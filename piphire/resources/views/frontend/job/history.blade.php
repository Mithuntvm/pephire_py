						...
						<div class="history-block">
							<div>
								@if(!$jobs->isEmpty())
									...
									@if($single_job->ruid == 'shortlisted')
										<a href="{{url('/interview/shortlisted/view/'.$single_job->juid)}}">
											@elseif ($single_job->ruid == 'timeslot')
											<a href="{{url('/interview/timeslot/view/'.$single_job->juid)}}">
											@elseif ($single_job->ruid == 'scheduled')
											<a href="{{url('/interview/scheduled/view/'.$single_job->juid)}}">
									@else
									<a href="{{url('/job/details/'.$single_job->juid)}}">
										@endif
									...
									<div class="section">
										<div class="row">
											<div class="col-md-6 col-xs-12">
												...
												<!-- <input class="checkindates"  type="text" value="@if($startdate){{$startdate}}@endif" name="from" class="form-control"> -->
