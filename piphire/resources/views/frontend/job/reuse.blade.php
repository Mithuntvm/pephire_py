			...
			<form method="post" enctype="multipart/form-data" id="jobcreate">
				...
				<div class="row">
					<div class="col-md-12 col-xs-12 analyze-candidateblock">
						<div>
							<div class="candidate-block @if($history) active-color @endif">
								<div class="icon-box">
							...
							<div class="candidate-block @if($history) @if($history->is_recoment) active-color @endif @endif">
								<div class="icon-box">
						...
						<div class="common-section">
							<div class="common-form fitment-form">
								<div class="form-section">
									...
									<input class="form-control" type="text" id="jobtitle" name="jobtitle" placeholder="Add Job Title here" @if($history) value="{{$history->name}}" @endif>
									<?php
									if ($history->name!='') {
								...
								<div class="form-section">
									...
									<textarea class="form-control " type="text" placeholder="Add Job Description here" id="jobdescription" name="jobdescription" rows="15" onchange="function_alert(event)">@if($history){{$history->description}}@endif</textarea>
									<img src="{{url('/')}}/assets/images/icons/tick.png">
								</div>
								<div class="form-section">
									...
									<div id="mand_skills">
										...
										<select multiple class="form-control skills" id="skills" name="skills[]" data-parsley-required-message="Please enter atleast one Skill">
											...
											<?php
												...
												$skills = explode(",", $history->mandatory_skills);
												$skills = str_replace("'", "", $skills)
											?>
												@foreach($skills as $sk)
												<option value="{{$sk}}" selected="selected"> {{ $sk }} </option>
								...
								<div class="form-section">
									<div class="row">
										...
										<div class="col-md-6">
											...
											<input class="form-control @if($history) @if($history->min_experience) valid  @endif @endif" type="number" id="min_experience" name="min_experience" placeholder="Min Experience" @if($history) value="{{$history->min_experience}}" @endif oninput="this.value = Math.abs(this.value)">
											<img src="{{url('/')}}/assets/images/icons/tick.png" style="margin-right: 5%">
										</div>
										<div class="col-md-6">
											<label class="control-label">Max Experience</label>
											<input class="form-control" type="number" id="max_experience" name="max_experience" placeholder="Max Experience" @if($history) value="{{$history->max_experience}}" @endif oninput="this.value = Math.abs(this.value)">
											<img src="{{url('/')}}/assets/images/icons/tick.png" style="margin-right: 5%">
										</div>
									</div>
								</div>
								...
								<div class="form-section">
									<div class="row">
										<div class="col-md-6">
											...
											<input class="form-control" type="text" id="joining_date" name="joining_date" placeholder="Joining Date" @if($history) value="{{$history->joining_date}}" @endif required>
											<!-- <img src="{{url('/')}}/assets/images/icons/tick.png"> -->
										</div>
										<div class="col-md-6">
											<label class="control-label">Location</label>
											<input class="form-control " type="text" id="location" name="location" placeholder="Location" @if($history) value="{{$history->location}}" @endif>
											<img src="{{url('/')}}/assets/images/icons/tick.png" style="margin-right: 5%">
										</div>
										<div class="col-md-6">
											<label class="control-label">Offered CTC</label>
											<input class="form-control" type="number" id="offered_ctc" name="offered_ctc" placeholder="Offered CTC" @if($history) value="{{$history->offered_ctc}}" @endif oninput="this.value = Math.abs(this.value)">
											<img src="{{url('/')}}/assets/images/icons/tick.png" style="margin-right: 5%">
										</div>
									</div>
								</div>
								...
								<div class="form-section">
									...
									<select class="form-control" name="job_role" id="job_role">
										...
										<option value="{{ $job_role }}" @if($history) @if($history->job_role == $job_role) selected="" @endif @endif>
											{{ ucfirst($job_role) }}
										</option>
										@endforeach
									</select>
								...
								<!-- <div class="form-section">
									<label class="control-label">Job Role Category </label>
									<select class="form-control" name="job_role_category" id="job_role_category">
										<option value=""> -- Select Job Role Category  -- </option>
										@foreach($job_role_categories as $job_role_category)
											<option value="{{ $job_role_category }}" @if($existjob) @if($existjob->job_role_category == $job_role_category) selected="" @endif @endif>
												{{ $job_role_category }}
											</option>
										@endforeach
									</select>
