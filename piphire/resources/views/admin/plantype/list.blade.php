...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#plantypes').DataTable({
                ajax: {
                    url: "{{ action('Admin\AdminPlantypeController@dataTable') }}",
                    type: "POST",
                    data: {
    ...
    @endif
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Plan Types</h3>
        ...
        <div class="content-header-right col-md-6 col-12">
          <div class="float-md-right">
            <div class="form-group">
              <!-- basic buttons -->
              <a href="{{url('/backend/plantype/create')}}" class="btn btn-success">Create</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="card">
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <p class="card-text"></p>
                    <table id="plantypes" class="table table-striped table-bordered file-export">
                      <thead>
                        <tr>
                          <th>Name</th>
                          <th>Start Date</th>
