  ...
  <script type="text/javascript">
      ...
      $(document).ready(function(){
        $("#plancreate").validate({
              ...
              messages: {
                name: {
                  required : "Please enter plan type name"
                }               
              },
            });
        });    
                    ...
                    <form id="plancreate" method="post" class="form form-horizontal form-bordered">
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="date" id="projectinput2" name="start_date" class="form-control" value="">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="date" id="projectinput3" name="end_date" class="form-control" value="">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input id="projectinput4" name="frontend_show" type="checkbox">
                          </div>
                        </div>
