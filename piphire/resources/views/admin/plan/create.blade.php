              ...
              <div class="card">
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form id="plancreate" method="post" class="form form-horizontal form-bordered">
                      @csrf
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" id="projectinput3" class="form-control" placeholder="Amount" name="amount">
                          </div>
                        </div>
                        ...
                        <div class="form-group row last">
                          ...
                          <div class="col-md-9">
                            <input type="number" id="projectinput4" class="form-control" placeholder="No.of Searches" name="no_of_searches">
                          </div>
                        </div>
                        ...
                        <div class="form-group row last">
                          ...
                          <div class="col-md-9">
                            <input type="number" id="projectinput14" class="form-control" placeholder="No.of Resumes" name="max_resume_count">
                          </div>
                        </div>
                        ...
                        <div class="form-group row last">
                          ...
                          <div class="col-md-9">
                            <input type="number" id="projectinput5" class="form-control" placeholder="No.of Users" name="max_users">
                          </div>
                        </div>
                        ...
                        <div class="form-group row last">
                          ...
                          <div class="col-md-9">
                            <textarea id="projectinput7" placeholder="Description" name="description" class="form-control"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input id="projectinput14" name="frontend_show" type="checkbox">
                          </div>
                        </div>
