              ...
              <div class="card">
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form id="usercreate" method="post" class="form form-horizontal form-bordered">
                      @csrf
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" id="projectinput3" class="form-control" placeholder="Email" name="email">
                          </div>
                        </div>
